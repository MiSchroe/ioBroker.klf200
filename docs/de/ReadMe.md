...
![Screenshot of Recording in progress](https://github.com/MiSchroe/ioBroker.klf200/blob/master/docs/de/img/RecordProgramButton.PNG?raw=true)
...
![Screenshot of the program list](https://github.com/MiSchroe/ioBroker.klf200/blob/master/docs/de/img/RecordingInProgress.PNG?raw=true)
